...
{
    /// <summary>
    /// An implementation of Enhanced PAM clustering algorithm.
    /// Essentially, this is usual PAM with heruistics to reduce cluster assignment time.
    /// </summary>
    ...
    public class EPAMClusteringAlgorithm<T> : IClusteringAlgorithm<T>
    {
        ...
        /// <param name="accelBuffer">Array of distances generated by previous iteration. Used for heruistics.</param>
