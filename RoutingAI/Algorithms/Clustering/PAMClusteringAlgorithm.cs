...
namespace RoutingAI.Algorithms.Clustering
{
    public class PAMClusteringAlgorithm<T> : IClusteringAlgorithm<T>
    {
        ...
        public virtual void Run()
        {
            ...
            _totalDistance = RunPAM(_data, _centroids, _clusters, _clusterAssignment);
        }
        /// <summary>
        ...
        protected Int32 RunPAM(T[] items, T[] centroids, List<T>[] clusters, Dictionary<T, Int32> assignment)
        {
            ...
            do
            {
                ...
                totalDistance = AssignItemsToCentroids(items, centroids, clusters, assignment);
        ...
        protected Int32 AssignRandomCentroids(T[] items, T[] centroids, List<T>[] clusters, Dictionary<T, Int32> assignment)
        {
            ...
            // Assign Items
            return AssignItemsToCentroids(items, centroids, clusters, assignment);
        }
        /// <summary>
        ...
        /// <param name="assignment">Cluster assignment data, this method overwrites it</param>
        /// <returns>Sum of distances for this cluster assignment</returns>
        protected Int32 AssignItemsToCentroids(T[] items, T[] centroids, List<T>[] clusters, Dictionary<T, Int32> assignment)
        {
